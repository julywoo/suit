...
import 'package:bykak/src/pages/tailorShop/cost_setting_page.dart';
import 'package:bykak/src/pages/tailorShop/options_manage_page.dart';

import 'package:bykak/src/widget/custom_elevated_buttod.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class CostIntro extends StatefulWidget {
  CostIntro({Key? key}) : super(key: key);

  @override
  State<CostIntro> createState() => _CostIntroState();
}

class _CostIntroState extends State<CostIntro> {
  String _selectedOption = "";
  String factoryName = Get.arguments['factoryName'];
                          ...
                          children: [
                            Container(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  Get.to(CostSetting(), arguments: {
                                    'options': _selectedOption,
                                    'factoryName': factoryName
                                  });
                                },

                                child: const Text('공임비 입력'),
                              ),
                            ),
                          ],
                        ),
