...
class InputShirtSize extends StatefulWidget {
  InputShirtSize({Key? key}) : super(key: key);

  @override
  State<InputShirtSize> createState() => _InputShirtSizeState();
}

class _InputShirtSizeState extends State<InputShirtSize> {
  @override
  void initState() {
  ...
  void saveDesign() {
    ...
    try {
      orders.doc(orderNo).update({
        'shirtSize': inputShirtSize!.toJson(),
      });
      print('데이터 저장 완료');
      Get.to(SearchPage());
    } catch (e) {
