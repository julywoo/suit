...
import 'package:bykak/src/components/constants.dart';
...
class FactoryCostUpdate extends StatefulWidget {
  const FactoryCostUpdate({Key? key}) : super(key: key);

  @override
  State<FactoryCostUpdate> createState() => _FactoryCostUpdateState();
}

class _FactoryCostUpdateState extends State<FactoryCostUpdate> {
  @override
  void initState() {
    getData();
    _getStoreList();
...
// // 2. Future.delayed
  ...
  var resultCostEtc;
  var resultCostGabong;
  var resultCostGabongSub;
  var resultCostJacket;
  var resultCostNormal;
  var resultCostPants;
  var resultCostShirt;
  var resultCostVest;
  _getStoreList() async {
    ...
    var tailorShopCostResult = await firestore
        .collection('factory')
        .doc(factoryName)
        .collection('costList')
        .doc(storeInitVal + '_' + "")
    ...
    setState(() {
      resultCostEtc = tailorShopCostResult['costEtc'];
      resultCostGabong = tailorShopCostResult['costGabong'];
      resultCostGabongSub = tailorShopCostResult['costGabongSub'];
      resultCostJacket = tailorShopCostResult['costJacket'];
      resultCostNormal = tailorShopCostResult['costNormal'];
      resultCostPants = tailorShopCostResult['costPants'];
      resultCostShirt = tailorShopCostResult['costShirt'];
      resultCostVest = tailorShopCostResult['costVest'];
    });
    storeList = [];
  ...
  getData() async {
    try {
      ...
      //getTailorShopCost(factoryName, storeInitVal, "");
    } catch (e) {}
  }
  ...
  getTailorShopCost(String factory, String shopName, String brandRate) async {
    Future.delayed(Duration(seconds: 1), () {
      setState(() {
        _isLoading = false;
      });
  ...
  getTailorShopBrand(String shopName) async {
    ...
    getTailorShopCost(factoryName, shopName, brandListInit);
  }
                        ...
                        Container(
                          ...
                          child: DropdownButtonFormField(
                            ...
                            onChanged: (String? newValue) {
                              ...
                              getTailorShopCost(
                                  factoryName, storeInitVal, brandListInit);
                            },
                          ),
                        ),
                        Container(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          initialValue:
                                              resultCostGabongSub['gabongSub1']
                                                  .toString(),
                                          textAlign: TextAlign.center,
                                          onSaved: (value) {
                                            costGabongSubList[0] =
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          initialValue:
                                              resultCostGabongSub['gabongSub2']
                                                  .toString(),
                                          textAlign: TextAlign.center,
                                          onSaved: (value) {
                                            costGabongSubList[1] =
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          initialValue:
                                              resultCostGabongSub['gabongSub3']
                                                  .toString(),
                                          textAlign: TextAlign.center,
                                          onSaved: (value) {
                                            costGabongSubList[2] =
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          initialValue:
                                              resultCostGabongSub['gabongSub4']
                                                  .toString(),
                                          textAlign: TextAlign.center,
                                          onSaved: (value) {
                                            setState(() {
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          initialValue:
                                              resultCostGabongSub['gabongSub5']
                                                  .toString(),
                                          textAlign: TextAlign.center,
                                          onSaved: (value) {
                                            costGabongSubList[4] =
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          initialValue: resultCostVest['vest1']
                                              .toString(),
                                          textAlign: TextAlign.center,
                                          onSaved: (value) {
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          initialValue: resultCostVest['vest2']
                                              .toString(),
                                          textAlign: TextAlign.center,
                                          onSaved: (value) {
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          initialValue: resultCostVest['vest3']
                                              .toString(),
                                          textAlign: TextAlign.center,
                                          onSaved: (value) {
