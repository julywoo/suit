...
class _SameItemAdditionalState extends State<SameItemAdditional>
  ...
  void initState() {
    ...
    userVal = [
      orderData.suitDesign!.jacketButton,
      orderData.suitDesign!.jacketLapel,
      orderData.suitDesign!.jacketChestPocket,
      orderData.suitDesign!.jacketShoulder,
      orderData.suitDesign!.jacketSidePocket,
      orderData.suitDesign!.jacketVent,
      orderData.suitDesign!.vestButton,
      orderData.suitDesign!.vestLapel,
      orderData.suitDesign!.pantsPleats,
      orderData.suitDesign!.pantsDetailOne,
      orderData.suitDesign!.pantsDetailTwo,
      orderData.suitDesign!.pantsDetailThree,
      orderData.suitDesign!.pantsBreak,
      orderData.suitDesign!.pantsPermanentPleats,
      orderData.shirtDesign!.shirtPattern,
      orderData.shirtDesign!.shirtCollar,
      orderData.shirtDesign!.shirtCuffs,
      orderData.shirtDesign!.shirtPlacket,
      orderData.shirtDesign!.shirtOption,
    ];

    userValSub = [
      orderData.suitDesignVal!.jacketButton,
      orderData.suitDesignVal!.jacketLapel,
      orderData.suitDesignVal!.jacketChestPocket,
      orderData.suitDesignVal!.jacketShoulder,
      orderData.suitDesignVal!.jacketSidePocket,
      orderData.suitDesignVal!.jacketVent,
      orderData.suitDesignVal!.vestButton,
      orderData.suitDesignVal!.vestLapel,
      orderData.suitDesignVal!.pantsPleats,
      orderData.suitDesignVal!.pantsDetailOne,
      orderData.suitDesignVal!.pantsDetailTwo,
      orderData.suitDesignVal!.pantsDetailThree,
      orderData.suitDesignVal!.pantsBreak,
      orderData.suitDesignVal!.pantsPermanentPleats,
      orderData.shirtDesign!.shirtPattern,
      orderData.shirtDesign!.shirtCollar,
      orderData.shirtDesign!.shirtCuffs,
      orderData.shirtDesign!.shirtPlacket,
    ...
    if (orderData.orderType.toString() == "0") {
      setState(() {
        suitSet = suitOption2.sublist(0, 14);
        userValSet = userVal.sublist(0, 14);
        userValSubSet = userValSub.sublist(0, 14);
        itemCnt = 14;
        startIndex = 0;
      });
    } else if (orderData.orderType.toString() == "1") {
      setState(() {
        suitSet = suitOption2.sublist(0, 6);
        userValSet = userVal.sublist(0, 6);
        userValSubSet = userValSub.sublist(0, 6);
        itemCnt = 6;
        startIndex = 0;
      });
    } else if (orderData.orderType.toString() == "2") {
      setState(() {
        suitSet = suitOption2.sublist(14, 19);
        userValSet = userVal.sublist(14, 19);
        userValSubSet = userValSub.sublist(14, 19);

        itemCnt = 5;
        startIndex = 14;
      });
    } else if (orderData.orderType.toString() == "3") {
      setState(() {
        suitSet = suitOption2.sublist(8, 14);
        userValSet = userVal.sublist(8, 14);
        userValSubSet = userValSub.sublist(8, 14);
        orderTypeColor = '바지';
        itemCnt = 6;
        startIndex = 8;
      });
    } else if (orderData.orderType.toString() == "4") {
      setState(() {
        suitSet = suitOption2.sublist(6, 8);
        userValSet = userVal.sublist(6, 8);
        userValSubSet = userValSub.sublist(6, 8);
        orderTypeColor = '조끼';
        itemCnt = 2;
        startIndex = 6;
      });
    } else if (orderData.orderType.toString() == "5") {
      userValSet = suitOption2;
    }
      ...
      children: [
        Container(
          ...
          child: ListView.separated(
            itemCount: suitSet.length,
            itemBuilder: (BuildContext context, int index) {
              List<String> selectList = List.from(suitSet[index]['selectList']);
              List<String> selectListVal =
                  List.from(suitSet[index]['selectListVal']);
              ...
              return Column(
                ...
                children: [
                  ...
                  orderData.orderType.toString() == "0" && index == 0
                      ? Container(
                      ...
                      : index == 6
                          ...
                          : index == 8
                              ...
                              : Container(),
                  orderData.orderType.toString() == "1" && index == 0
                      ? Container(
                          padding: EdgeInsets.all(10),
                          child: Text(
                            '자켓 디자인 선택',
                      ...
                      : Container(),
                  orderData.orderType.toString() == "2" && index == 0
                      ? Container(
                          padding: EdgeInsets.all(10),
                          child: Text(
                            '셔츠 디자인 선택',
                      ...
                      : Container(),
                  orderData.orderType.toString() == "3" && index == 0
                      ? Container(
                          padding: EdgeInsets.all(10),
                          child: Text(
                            '바지 디자인 선택',
                      ...
                      : Container(),
                  orderData.orderType.toString() == "4" && index == 0
                      ? Container(
                          padding: EdgeInsets.all(10),
                          child: Text(
                            '조끼 디자인 선택',
                      ...
                      : Container(),
                  orderData.orderType.toString() == "5" && index == 0
                      ? Container(
                          padding: EdgeInsets.all(10),
                          child: Text(
                            '코트 디자인 선택',
                    ...
                    child: Wrap(
                      ...
                      children: [
                        for (var i = 0; i < selectList.length; i++)
                          aaaa(selectList[i], i, userValSet[index], selectList,
                              index, selectListVal)
                      ],
                    ),
                  ),
